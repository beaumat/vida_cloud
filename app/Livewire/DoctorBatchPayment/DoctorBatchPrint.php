...
class DoctorBatchPrint extends Component
{
   public int $n = 0;
    ...
    public function mount($id = null)
    {
        ...
        try {
            ...
            if ($data) {
                ...
                $this->billList = $this->billPaymentServices->getDoctorBatch($id);
    ...
    {
        return view('livewire.doctor-batch-payment.doctor-batch-print');
    }
}
