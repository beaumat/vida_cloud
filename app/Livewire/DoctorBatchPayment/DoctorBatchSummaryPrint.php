...
class DoctorBatchSummaryPrint extends Component
{
    public int $n = 0;
    ...
    public function mount($id = null)
    {
        ...
        try {
            ...
            if ($data) {
                $con = $this->contactServices->get($data->DOCTOR_ID, 4);
                if ($con) {
                    // get doctor name
                ...
                $this->billList = $this->doctorBatchServices->PaidList($id);
    ...
    {
        return view('livewire.doctor-batch-payment.doctor-batch-summary-print');
    }
}
