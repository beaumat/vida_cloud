...
class RequirementPanelComplete extends Component
{
    ...
    public function updatedvalue()
    {
        ...
        $this->contactRequirementServices->UpdateIsComplete($this->ID, $this->VALUE);
    ...
    {
        return view('livewire.patient.requirement-panel-complete');
    }
}
