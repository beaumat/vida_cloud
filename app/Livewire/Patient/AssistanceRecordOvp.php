...
class AssistanceRecordOvp extends Component
{
    #[Reactive]
    ...
    {
        $this->dataList = $this->patientPaymentServices->AssistanceByType(
            $this->CONTACT_ID,
            97,
    ...
    {
        $this->reload();
        return view('livewire.patient.assistance-record-ovp');
    }
}
