<div>
    ...
    <table class="table table-sm table-bordered table-hover">
        <thead class="text-xs bg-sky">
            <tr>
                ...
                <th class="col-1">Invoice Amount</th>
                <th class="col-1">Taxable Amount</th>
                <th class="col-1">Invoice Bal.</th>
        ...
        <tbody class="text-xs">
            @foreach ($dataList as $list)
                <tr>
                    ...
                    <td class="text-right">{{ number_format($list->TAXABLE_AMOUNT, 2) }} </td>
    ...
    @if ($STATUS == 0 || $STATUS == 16)
        @livewire('TaxCredit.InvoiceListModal', ['CUSTOMER_ID' => $CUSTOMER_ID, 'LOCATION_ID' => $LOCATION_ID, 'TAX_CREDIT_ID' => $TAX_CREDIT_ID, 'EWT_RATE' => $EWT_RATE])
    @endif
</div>
