                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="pt-1 pb-1 card-header bg-sky">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a class="text-white" href="{{ route('bankingbank_transfer') }}"> Bank Transfer
                                    </a>
                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="container">
                                                        <div class='row'>
                                                            ...
                                                            <div class="col-md-12">
                                                                @if ($Modify)
                                                                    <livewire:select-option name="TO_BANK_ACCOUNT_ID"
                                                                        titleName="To Bank Account" :options="$toAccountList"
                                                                        :zero="true" :isDisabled=false
                                                                        wire:model='TO_BANK_ACCOUNT_ID' />
                                                                @else
                                                                    <livewire:select-option name="TO_BANK_ACCOUNT_ID"
                                                                        titleName="To Bank Account" :options="$toAccountList"
                                                ...
                                                <div class="card-body">
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                @if ($Modify)
                                                                    <livewire:select-option name="FROM_BANK_ACCOUNT_ID"
                                                                        titleName="From Bank Account" :options="$fromAccountList"
                                                                        :zero="true" :isDisabled=false
                                                                        wire:model='FROM_BANK_ACCOUNT_ID' />
                                                                @else
                                                                    <livewire:select-option name="FROM_BANK_ACCOUNT_ID"
                                                                        titleName="From Bank Account" :options="$fromAccountList"
                                                                        :zero="true" :isDisabled=true
