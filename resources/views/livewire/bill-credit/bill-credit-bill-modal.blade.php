<div>
    <button wire:click="openModal" class="btn btn-success btn-sm text-xs ">
        <i class="fa fa-plus" aria-hidden="true"></i> Add Bills
    </button>
    @if ($showModal)
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-sm table-borderHed table-hover">
                            <thead class="bg-sky text-xs">
                                <tr>
                                    ...
                                    <th class="col-2">Credit Initial</th>
                                </tr>
                            </thead>
