<div class="print-container bg-white mx-auto text-black"
    ...
    <div class="text-center mb-4">
        <h1 style="font-size:14px; font-weight:bold; margin-bottom:6px;">
    ...
    <div style="margin-bottom:10px; text-align:justify;">
        <p style="margin-bottom:4px; font-weight:bold; font-size:11px;">
    ...
    <div style="margin-bottom:12px;">
        <h6 style="font-weight:bold; font-style:italic; font-size:11px; border-bottom:1px solid black; margin-bottom:6px;">
            I. PAGPILI NG PAMAMARAAN (PLEASE MARK YOUR CHOICE):
        </h6>

        <div style="margin-left:16px; line-height:1.3; font-size:11px;">
    ...
    <!-- SECTION II -->
    <div style="margin-bottom:12px;">
        <h6 style="font-weight:bold; font-style:italic; font-size:11px; border-bottom:1px solid black; margin-bottom:8px;">
            II. PAGSANG-AYON AT PAGKILALA (AGREEMENT AND ACKNOWLEDGMENT):
        </h6>

        <ol style="margin-left:18px; line-height:1.3; font-size:11px;">
        ...
        <p style="margin-top:6px; font-style:italic; font-size:10px;">
