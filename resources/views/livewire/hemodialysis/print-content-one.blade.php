        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-4 ">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 top-line2 text-center">
                                        <label class="text-sm">Complication (Procedure):</label>
                                    </div>
                                    <div class="col-4">
                                        <div class="text-xs">
                                            [&nbsp;&nbsp;]&nbsp;&nbsp;Headache
                        ...
                        <div class="col-4 left-line2">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 top-line2 text-center">
                                        <label class="text-sm">PATIENT UNDERSTAND:</label>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-xs">
                                            [&nbsp;&nbsp;]&nbsp;&nbsp;&nbsp;DEIT & PRESCRIPTION
                ...
                <div class="col-12 left-line2 right-line2 bottom-line2">
                    <div class="row">
                        <div id="PRE-HEMODIALYSIS" class="col-6">
                            <div class="row">
                                <div class="col-12 bottom-line2 text-center">
                        ...
                        <div id="POST-HEMODIALYSIS" class="col-6 left-line2">
                            <div class="row">
                                <div class="col-12 bottom-line2 text-center">
                    ...
                    <table width="100%" class="col-12 left-line2 right-line2 bottom-line2">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th class=" left-line2">HR</th>
                                <th class=" left-line2">BFR</th>
                                <th class=" left-line2">AP | VP</th>
                                <th class="col-2 left-line2">TFR</th>
                                <th class=" left-line2">TMP</th>
                                <th class=" left-line2">HEPARIN | <br /> FLUSHING</th>
                                <th class=" left-line2">NURSES NOTES</th>
                ...
                <div class="col-4 p-0 m-0 right-line2">
                    <div class="m-1 row">
                        <div class=" col-12 text-center top-line2 left-line2 bottom-line2  right-line2 font-weight-bold"> HEALTH
                            TEACHINGS</div>
