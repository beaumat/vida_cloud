                 ...
                 <div class="card-body">
                     ...
                     <table class="table table-sm table-bordered table-hover">
                         <thead class="text-xs bg-sky">
                             <tr>
                                 <th class="col-2">Date Transfer</th>
                         ...
                         <tbody class="text-xs">
                                     ...
                                     <td>
                                         @if ($E_ID == $list->ID)
                                             <input type="date" class="form-control form-control-sm"
                                                 name="date_start" wire:model='E_DATE_TRANSFER' />
                                         @else
                                             {{ date('m/d/Y', strtotime($list->DATE_TRANSFER)) }}
                                         @endif
                                     </td>
                                     <td>
                                         @if ($E_ID == $list->ID)
                             ...
                             @endforeach
                             <tr>
                                 <td><input type="date" class="form-control form-control-sm" name="date_transfer"
                                         wire:model='DATE_TRANSFER' /></td>
