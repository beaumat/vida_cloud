            ...
            <div class="card bg-light">
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <livewire:select-option name="LOCATION_ID" :options="$locationList" :zero="false"
                                titleName="Location" isDisabled="{{ false }}" wire:model.live='LOCATION_ID'
                                :vertical="true" />
                        </div>
                    </div>
                    ...
                    <table class="table table-sm table-bordered table-hover">
                        <thead class="text-sm bg-sky">
                            <tr>
                                <th>Code</th>
                                <th> Description</th>
                                <th class="text-right col-1">Qunatity</th>
