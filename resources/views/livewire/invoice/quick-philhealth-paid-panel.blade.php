            ...
            <div class="modal-dialog modal-md" role="document"
                ...
                <div class="modal-content text-left">
                    <div class="modal-header">
                        <h6 class="modal-title">Philhealth Details</h6>
                                    ...
                                    <div class="card text-xs">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-4"><label>LHIO Date : </label></div>
                                                <div class="col-8 text-primary">{{ date('M/d/Y', strtotime($DATE)) }}
                                                </div>
                                                <div class="col-4"><label>LHIO No. : </label></div>
                                        ...
                                        <div class="card text-xs">
                                            ...
                                            <div class="card-body">
                                                <table class="table table-sm table-bordered table-hover mt-1">
                                                    ...
                                                    <tbody>
                                                        @foreach ($INVOICE_TREATMENT_LIST as $list)
                                                            <tr>
                                                                <td>{{ $list->CODE }}</td>
